...
% resume starts here
\begin{center}
    \textbf{\Huge Alexandru Pascan} \\
    \href{mailto:alexandru@pascan.ro}{alexandru@pascan.ro} | \href{https://github.com/alpascan}{github.com/alpascan} | Swiss B permit holder
\end{center}
...
\subsection*{Software Engineer in Test, Nexthink – Lausanne, Switzerland \hfill September 2019 – Present}
\begin{itemize}[leftmargin=*]
...
\subsection*{Quality Assurance Engineer, R3PI – Zurich, Switzerland \hfill Jan 2021 – May 2022}
\begin{itemize}[leftmargin=*]
...
\subsection*{QA Engineer, Company – City, ST \hfill Aug 2014 – Sept 2020}
\begin{itemize}[leftmargin=*]
...
\section*{Education}
\begin{itemize}[leftmargin=*]
    \item \textbf{Universitatea Stefan Cel Mare} – BS in Mechanical Engineering \hfill Apr 2004
\end{itemize}
